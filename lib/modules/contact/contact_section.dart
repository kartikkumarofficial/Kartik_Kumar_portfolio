...
import 'package:portfolio/shared/animations/scroll_reveal.dart';
...
class _ContactSectionState extends State<ContactSection> {
  ...
  Future<void> _openEmailClient() async {
    try {
      ...
      final mailtoUrl = 'mailto:work.kartikkumar@gmail.com?subject=$subject&body=$body';
          ...
          const SnackBar(
            content: Row(
              children: [
                ...
                SizedBox(width: 8),
                Expanded(child: Text('Error: Please email me directly at work.kartikkumar@gmail.com')),
              ],
            ),
  ...
  Widget _buildContent(ThemeData theme) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Have a project in mind? Send me a message below or email me directly at work.kartikkumar@gmail.com',
                ...
                child: ElevatedButton(
                  ...
                  child: _isSubmitting
                    ...
                    children: [
                      ...
                      if (showButtonText)
                        const Text('Sending...', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                    ],
                  )
                      : Row(
                    mainAxisAlignment: MainAxisAlignment.center,
